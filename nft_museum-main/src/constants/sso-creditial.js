...
const url = `${BASE_URL.URL_TOKEN}${USER_MANAGEMENT.AUTH_CODE}client_id=${OIDC_CONFIG.CLIENT_ID}&redirect_uri=https://main--nft-museum-dev.netlify.app&scope=${OIDC_CONFIG.SCOP}&response_type=${OIDC_CONFIG.RESPONSE_TYPE}&grant_type=${OIDC_CONFIG.GRANT_TYPE}`;
...
export { SSO_CREDITIAL, OIDC_CONFIG, IDENTITY_CONFIG, METADATA_OIDC };
